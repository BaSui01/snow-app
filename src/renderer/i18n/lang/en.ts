export const en = {
  ...
  "toolCall.lsp.op.diagnostics": "File Diagnostics",
  "toolCall.lsp.op.hover": "Type and Documentation Lookup",
  "toolCall.lsp.op.goto": "Symbol Navigation",
  "toolCall.lsp.op.completion": "complete",
  "toolCall.lsp.op.references": "Find References",
  "toolCall.lsp.op.symbols": "File Symbol Outline",
  "toolCall.lsp.op.rename": "Rename Symbol",
  ...
  "toolCall.lsp.op.workspace-symbols": "Workspace Symbol Search",
  "toolCall.lsp.op.execute-command": "Execute command",
  "toolCall.lsp.op.call-hierarchy": "Function Call Hierarchy",
  "toolCall.lsp.op.type-hierarchy": "Type Hierarchy",
  "toolCall.lsp.op.workspace-diagnostics": "Workspace Diagnostics",
  "toolCall.lsp.op.vulncheck": "Go Dependency Vulnerability Scan",
  "toolCall.lsp.progress.elapsedTitle": "LSP elapsed time",
  "toolCall.lsp.progress.timeoutHint":
    "Duration depends on server startup, queueing and analysis.",
  "toolCall.lsp.progress.default":
    "Requesting semantic analysis from language server...",
  "toolCall.lsp.progress.diagnostics":
    "Analyzing compilation diagnostics and syntax errors...",
  "toolCall.lsp.progress.workspaceDiagnostics":
    "Aggregating project-wide diagnostics across languages (initial build may take 10-30s)...",
  "toolCall.lsp.progress.workspaceSymbols":
    "Searching symbols in the current workspace...",
  "toolCall.lsp.progress.symbols": "Extracting file symbol outline...",
  "toolCall.lsp.progress.rename":
    "Calculating global cross-references and rename diff...",
  "toolCall.lsp.progress.codeAction": "Querying code fixes and refactorings...",
  "toolCall.lsp.progress.executeCommand":
    "Requesting language server to execute command...",
  "toolCall.lsp.progress.callHierarchy": "Analyzing call hierarchy...",
  "toolCall.lsp.progress.typeHierarchy": "Analyzing type hierarchy...",
  "toolCall.lsp.progress.hover": "Fetching hover type and doc comments...",
  "toolCall.lsp.progress.goto":
    "Navigating to symbol definition and implementations...",
  "toolCall.lsp.progress.references": "Searching references across project...",
  "toolCall.lsp.progress.vulncheck":
    "Running dependency vulnerability scan (govulncheck)...",
  ...
  "toolCall.lsp.waiting": "Waiting for the tool result",
  ...
  "toolCall.lsp.symbol": "Symbol",
  "toolCall.lsp.ambiguousCount": "{{count}} candidate(s)",
  "toolCall.lsp.query": "Symbol search query",
  ...
  "toolCall.lsp.referencesCount": "{{count}} reference(s)",
  "toolCall.lsp.noReferences": "No references found",
  "toolCall.lsp.vulnCount": "{{count}} vulnerability(ies)",
  "toolCall.lsp.noVulns": "No known vulnerabilities found",
  "toolCall.lsp.packagesAffected": "{{count}} affected package(s)",
  "toolCall.lsp.command": "Command",
  "toolCall.lsp.dir": "Directory",
  "toolCall.lsp.pattern": "Pattern",
  "toolCall.lsp.maxFiles": "Max files",
  "toolCall.lsp.kind": "Kind",
  ...
  "toolNames.lsp-diagnostics": "File Diagnostics",
  "toolNames.lsp-hover": "Type and Documentation Lookup",
  "toolNames.lsp-goto": "Symbol Navigation",
  "toolNames.lsp-references": "Find References",
  "toolNames.lsp-symbols": "File Symbol Outline",
  "toolNames.lsp-rename": "Rename Symbol",
  "toolNames.lsp-code-action": "Code action",
  "toolNames.lsp-signature-help": "Signature help",
  "toolNames.lsp-call-hierarchy": "Function Call Hierarchy",
  "toolNames.lsp-type-hierarchy": "Type Hierarchy",
  "toolNames.lsp-execute-command": "Execute Command",
  "toolNames.lsp-workspace-symbols": "Workspace Symbol Search",
  "toolNames.lsp-workspace-diagnostics": "Workspace Diagnostics",
  "toolNames.lsp-vulncheck": "Go Dependency Vulnerability Scan",
  ...
  "settings.lspStatusRunning": "Running",
  "settings.lspStatusIdle": "Idle",
  "settings.lspStatusDead": "Stopped",
  "settings.lspStatusExited": "Exited unexpectedly",
  "settings.lspStart": "Start",
  "settings.lspStop": "Stop",
  "settings.lspRestart": "Restart & refresh cache",
  "settings.lspStarting": "Starting…",
  "settings.lspStopping": "Stopping…",
  "settings.lspRestarting": "Restarting…",
  "settings.lspStartSuccess": "{{lang}} language server started.",
  "settings.lspStopSuccess": "{{lang}} language server stopped.",
  "settings.lspRestartSuccess":
    "{{lang}} language server restarted and cache refreshed.",
  "settings.lspOperationError": "LSP operation failed",
