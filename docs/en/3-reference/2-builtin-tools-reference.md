...
| `n`                 | number            | Always 1 — generating multiple images per call is disabled (n>1 is rejected). To create several images, call this tool multiple times; parallel calls run concurrently (capped by maxConcurrentImages) |
