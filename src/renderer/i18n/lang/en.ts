export const en = {
  ...
  "toolCall.lsp.op.hover": "Hover",
  "toolCall.lsp.op.goto": "Go to",
  "toolCall.lsp.op.completion": "complete",
  "toolCall.lsp.op.references": "References",
  "toolCall.lsp.op.symbols": "Symbols",
  ...
  "toolCall.lsp.op.vulncheck": "Vuln check",
  "toolCall.lsp.progress.elapsedTitle": "LSP elapsed time",
  "toolCall.lsp.progress.timeoutHint":
    "Safety timeout protection: {{seconds}}s, will automatically abort and release on timeout",
  ...
  "toolCall.lsp.progress.workspaceSymbols":
    "Searching project symbols index...",
  ...
  "toolNames.lsp-workspace-symbols": "Workspace symbols",
  "toolNames.lsp-workspace-diagnostics": "Workspace diagnostics",
  "toolNames.lsp-vulncheck": "Vulnerability check",
