export const en = {
  ...
  "settings.dataManagementAutomaticBackup": "Automatic backup",
  "settings.dataManagementEnableScheduledSnapshots": "Enable scheduled snapshots",
  "settings.dataManagementFrequency": "Frequency",
  "settings.dataManagementEvery6Hours": "Every 6 hours",
  "settings.dataManagementEvery12Hours": "Every 12 hours",
  "settings.dataManagementDaily": "Daily",
  "settings.dataManagementWeekly": "Weekly",
  "settings.dataManagementKeepSnapshots": "Keep snapshots",
  "settings.dataManagementBackupDirectory": "Backup directory",
  "settings.dataManagementBackupDirectoryPlaceholder":
    "Default application backup directory",
  "settings.dataManagementBrowse": "Browse",
  "settings.dataManagementSelectBackupDirectory": "Select backup directory",
  "settings.dataManagementIncludeArchive": "Include archive.db",
  "settings.dataManagementSafetySnapshotBeforeImport": "Safety snapshot before import",
  "settings.dataManagementSafetySnapshotBeforeRestore": "Safety snapshot before restore",
  "settings.dataManagementAttachmentNote":
    "Attachment files are intentionally not included in this release; database snapshots remain portable and bounded.",
  "settings.dataManagementCreateSnapshotInfo":
    "Copies both databases through SQLite Online Backup, checks them, and commits one atomic package.",
  "settings.dataManagementCreateSnapshotNow": "Create snapshot now",
  "settings.dataManagementSnapshotsAvailable": "{{count}} snapshot(s) available",
  "settings.dataManagementAvailableSnapshots": "Available snapshots",
  "settings.dataManagementRestoreAction": "Restore",
  "settings.dataManagementDelete": "Delete",
  "settings.dataManagementNoSnapshotsYet": "No snapshots yet.",
  "settings.dataManagementRestoreConfirm":
    "Restore snapshot from {{time}} and restart Snow App?",
  "settings.dataManagementDeleteConfirm": "Delete snapshot {{id}}?",
  "settings.dataManagementEncryptedEtagSync": "Encrypted ETag sync",
  "settings.dataManagementWebdavPassword": "WebDAV password",
  "settings.dataManagementConfigured": "Configured",
  "settings.dataManagementRequired": "Required",
  "settings.dataManagementSyncEncryptionPassword": "Sync encryption password",
  "settings.dataManagementSyncMode": "Sync mode",
  "settings.dataManagementConfigurationSync": "Configuration sync",
  "settings.dataManagementFullMirror": "Full database mirror (restart)",
  "settings.dataManagementAutomaticSync": "Automatic sync",
  "settings.dataManagementManualOnly": "Manual only",
  "settings.dataManagementEvery15Minutes": "Every 15 minutes",
  "settings.dataManagementEvery30Minutes": "Every 30 minutes",
  "settings.dataManagementEveryHour": "Every hour",
  "settings.dataManagementAllowInsecureHttp":
    "Allow insecure HTTP (high risk; HTTPS remains the default)",
  "settings.dataManagementRemoteEncryptedNote":
    "Remote objects are encrypted before upload; passwords never leave the main process.",
  "settings.dataManagementEnableAutomaticSync": "Enable automatic sync",
  "settings.dataManagementTestConnection": "Test connection",
  "settings.dataManagementSyncNow": "Sync now",
  "settings.dataManagementConnectionWeakEtag":
    "Connected; server has weak ETag protection",
  "settings.dataManagementConnectionReady": "WebDAV connection is ready",
  "settings.dataManagementSyncCompleted": "Sync completed",
  "settings.dataManagementConflictTitle": "Sync conflict needs a choice",
  "settings.dataManagementConflictInfo":
    "Remote revision {{revision}} from {{device}}; local data was kept.",
  "settings.dataManagementKeepLocal": "Keep local and upload",
  "settings.dataManagementUseRemote": "Use remote",
  "settings.dataManagementKeepBoth": "Keep both",
  "settings.dataManagementSyncStatusLabel": "Sync status: {{status}}",
  "settings.dataManagementLastSyncAt": "Last successful sync: {{time}}",
  "settings.dataManagementNoSyncYet": "No successful sync recorded yet.",
  "settings.dataManagementLatestError": "Latest error: {{error}}",
  "settings.dataManagementSectionApiConfig": "API and model configuration",
  "settings.dataManagementSectionModelSettings": "Model settings",
  "settings.dataManagementSectionSystemSettings": "System settings",
  "settings.dataManagementSectionMcp": "MCP servers",
  "settings.dataManagementSectionPrompts": "Prompts and commands",
  "settings.dataManagementSectionHooks": "Hooks",
  "settings.dataManagementSectionSubAgents": "Sub-agents",
  "settings.dataManagementSectionKeyboardShortcuts": "Keyboard shortcuts",
  "settings.dataManagementSectionTheme": "Theme",
  "settings.dataManagementSectionSkills": "Portable skills",
  "settings.dataManagementSectionPlugins": "Managed plugins",
  "settings.dataManagementExportPasswordPrompt":
    "Set an encryption password for this export",
  "settings.dataManagementExportedRows": "Exported {{rows}} configuration rows",
  "settings.dataManagementImportPasswordPrompt": "Enter the package encryption password",
  "settings.dataManagementImportDescription": "{{rows}} rows, {{sections}} sections",
  "settings.dataManagementImportConfirm":
    "Import this configuration package ({{description}})?",
  "settings.dataManagementImportedRows": "Imported {{rows}} configuration rows",
  "settings.dataManagementExportEncryptedPackage": "Export encrypted package",
  "settings.dataManagementExportPackage": "Export package",
  "settings.dataManagementIncludeSensitive":
    "Include sensitive configuration (requires encryption)",
  "settings.dataManagementImportAndPreview": "Import and preview changes",
  "settings.dataManagementReplaceSelected": "Replace selected sections",
  "settings.dataManagementLastImportPreview": "Last import preview",
  "settings.dataManagementPreviewSummary":
    "{{rows}} rows across {{sections}} sections; estimated payload {{bytes}} bytes.",
  "settings.dataManagementPreviewRedacted":
    "{{count}} device-specific values are redacted.",
  "settings.dataManagementDeviceShort": "device {{id}}",
