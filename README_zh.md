...
在 **设置 → 手机远控** 中完成配对，即可从手机浏览器控制当前 Snow 会话。局域网模式不依赖云服务；可选的公网模式使用自建的 TLS 鉴权隧道，并支持一次性配对、会话撤销、工具授权与敏感输出脱敏。详情见[手机公网远控指南](docs/zh-CN/2-使用指南/23-手机公网远控.md)。

手机远控初始版本由 [zerio1](https://github.com/zerio1) 通过 [PR #130](https://github.com/MayDay-wpf/snow-app/pull/130) 贡献，由 Snow App 整合优化。

| 对话与流式输出                                            | 操作、模式与授权                                     |
| --------------------------------------------------------- | ---------------------------------------------------- |
| ![Snow 手机远控对话](docs/images/mobile-conversation.png) | ![Snow 手机远控操作](docs/images/mobile-actions.png) |
