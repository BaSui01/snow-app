...
**Settings → API configuration → Image models**.

## 1. Where to Configure

| Entry                                                                      | Description                                                 |
| -------------------------------------------------------------------------- | ----------------------------------------------------------- |
| Settings → API configuration → Image models (view id: `imagegen-settings`) | GUI: channel table with add/edit/delete                     |
...
Open **Settings → API configuration → Image models**: channels are managed as a **table** —
