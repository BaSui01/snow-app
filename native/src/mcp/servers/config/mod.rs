...
fn config_scope_supports_project_id(args: &Value) -> bool {
    ...
    match scope {
        ...
        SCOPE_MCP_SERVERS | SCOPE_TOOL_APPROVAL => true,
        "settings" => {
